...
defaut_config = '''{"server":{"host":"192.168.1.1","user":"phanhung", "password":30, "database":"New York"},"local":{"host":"localhost","user":"user", "password":27022003
, "database":"New York"},"camera":{"name":"noname","id":0}}'''
#read config file
try:
